...
library RateLimitedLibrary {
    ...
    function setRateLimitPerSecond(RateLimit storage limit, uint128 newRateLimitPerSecond) internal {
        sync(limit);
    ...
    function setBufferCap(RateLimit storage limit, uint128 newBufferCap) internal {
        sync(limit);
